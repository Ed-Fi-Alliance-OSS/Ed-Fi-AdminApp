...
import { CreateApiClientPageV2 } from '../Pages/ApiClientV2/CreateApiClientPage';
...
export const apiClientCreateRoute: RouteObject = {
  ...
  handle: { crumb: () => 'Create' },
  element: <VersioningHoc v2={<CreateApiClientPageV2 />} />,
};
...
export const apiClientsRoute: RouteObject = {
  path: '/as/:asId/sb-environments/:sbEnvironmentId/edfi-tenants/:edfiTenantId/applications/:applicationId/apiclients',
  handle: { crumb: () => 'Application Credentials' },
};
...
export const ApiClientLinkV2 = (props: {
  ...
  return apiClient ? (
    ...
    <Text title="Application credentials may have been deleted, or you lack access." as="i" color="gray.500">
      can't find &#8220;{props.id}&#8221;
    </Text>
  ) : null;
};
