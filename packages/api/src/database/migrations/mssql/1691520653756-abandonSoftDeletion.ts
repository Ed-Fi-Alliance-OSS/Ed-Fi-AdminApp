...
export class AbandonSoftDeletion1691520653756 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // No longer dropping this, for MSSQL
    ...
    // Another MSSQL-disallowed cascading FK due to possible cycles: edorg.sbeId -> sbe.id. Instead of a FK, replace with triggers. Seems to be a circular..
    // ODS.sbeId --> sbe.id
    // edorg.odsId --> ods.id
    // Deleting sbeId will already trigger a delete from edorg.
    // await queryRunner.query(
    ...
    // ODS.sbeId --> sbe.id
    // ownership.sbeId --> sbe.id
    // ownership.odsId --> ods.id
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE [ownership] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [role] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [role] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [user_tenant_membership] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [user_tenant_membership] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [edorg] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [edorg] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [sbe] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [sbe] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [ods] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [ods] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [tenant] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [tenant] ADD [deleted] datetime2`);
    await queryRunner.query(`ALTER TABLE [user] ADD [deletedById] integer`);
    await queryRunner.query(`ALTER TABLE [user] ADD [deleted] datetime2`);
    await queryRunner.query(
