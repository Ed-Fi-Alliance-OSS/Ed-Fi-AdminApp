...
import { EdorgMgmtServiceV3 } from './edorg-mgmt.v3.service';
import { OdsMgmtServiceV3 } from './ods-mgmt.v3.service';
import { TenantMgmtServiceV3 } from './tenant-mgmt.v3.service';
...
@Injectable()
export class StartingBlocksServiceV3 {
  private readonly logger = new Logger(StartingBlocksServiceV3.name);
  readonly tenantMgmtService = new TenantMgmtServiceV3();
  readonly odsMgmtService = new OdsMgmtServiceV3();
  readonly odsRowCountService = new OdsRowCountService();
  readonly edorgMgmtService = new EdorgMgmtServiceV3();
  constructor(
